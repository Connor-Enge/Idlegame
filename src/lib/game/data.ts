...
export const BASE_ASSETS: MarketAsset[] = [
  ...
  { id: "meme", symbol: "GME", name: "GameStonk", class: "stock", price: 22, volatility: 0.05, drift: 0.0006, sector: "consumer", logo: "🚀", popular: true, unlockLevel: 8, blurb: "The original meme stock. Fundamentals optional; vibes mandatory. 🦍💎🙌" },
  { id: "btc", symbol: "BTC", name: "Bitcorn", class: "crypto", price: 38000, volatility: 0.04, drift: 0.0012, sector: "crypto", logo: "₿", popular: true, unlockLevel: 9, blurb: "Digital gold. Trades 24/7 and doesn't care about your bedtime." },
  ...
  { id: "eth", symbol: "ETH", name: "Etherium", class: "crypto", price: 2100, volatility: 0.045, drift: 0.0014, sector: "crypto", logo: "Ξ", unlockLevel: 11, blurb: "The smart-contract platform. Powers most of the on-chain casino." },
  { id: "doge", symbol: "DOGE", name: "Dogecorn", class: "crypto", price: 0.12, volatility: 0.06, drift: 0.0008, sector: "crypto", logo: "🐕", unlockLevel: 12, blurb: "A joke that refused to die. Pure sentiment, much volatility, very risk." },
  { id: "lev3x", symbol: "BULL3X", name: "3x Leveraged Fund", class: "index", price: 240, volatility: 0.06, drift: 0.0009, sector: "broad", logo: "⚡", unlockLevel: 14, requiresCredential: "series7", blurb: "Triple-leveraged daily returns. Amplifies the upside — and decays brutally in chop. Not a buy-and-hold." },
];
